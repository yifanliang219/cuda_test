...
int main(int argc, char *argv[])
{
    ...
    printf("Output image: height %d, width: %d, channels: %d, size: %d\n", img_out.height, img_out.width, img_out.channels, (int)img_out.data.size());
